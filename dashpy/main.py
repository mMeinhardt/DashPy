...
def main():
    parser = argparse.ArgumentParser(prog="DashPy", description=ui_commons.main_help)
    subparsers = parser.add_subparsers(title="Valid commands", help=ui_commons.sub_help)

    parser_init = subparsers.add_parser("init", help=ui_commons.init_desc, description=ui_commons.init_desc)
    parser_init.set_defaults(func=commands.command_dict['init'])
    ...
    parser_check_balance.set_defaults(func=commands.command_dict['balance'])
    ...
    parser_send_trx.set_defaults(func=commands.command_dict['send'])
    ...
    parser_export.set_defaults(func=commands.command_dict['export'])
    ...
    parser_generate_new.set_defaults(func=commands.command_dict["generate-addresses"])
    ...
    parser_import.set_defaults(func=commands.command_dict["import"])
